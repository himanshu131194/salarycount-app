            ...
            <div className="col-lg-3 mb-5 mb-lg-0">
                ...
                <div id="sidebarNav" className="navbar-collapse collapse">
                    <div className="mt-5 mt-lg-0">
                        <h2 className="h4"><a className="text-inherit" href="#">Artificial Intelligence</a></h2>
                        <a className="dropdown-item d-flex justify-content-between align-items-center px-0" href="#">
                            AI Product Manager
                            <span className="badge bg-soft-secondary badge-pill">30+</span>
                        </a>
                        <a className="dropdown-item d-flex justify-content-between align-items-center px-0" href="#">
                    ...
                    <div className="mt-5">
                        <h3 className="h4"><a className="text-inherit" href="#">Data Science</a></h3>
                        <a className="dropdown-item d-flex justify-content-between align-items-center px-0" href="#">
                            Business Analytics
                        </a>
                        <a className="dropdown-item d-flex justify-content-between align-items-center px-0" href="#">
